...
export class MemStorage implements IStorage {
  ...
  private async initializeSampleData() {
    ...
    const sp5derTshirt = await this.createProduct({
      name: "SP5DER T-Shirt",
      slug: "sp5der-tshirt",
      description: "Authentic SP5DER t-shirt with the iconic spider web logo. Premium cotton construction for everyday comfort and style. NOT IN STOCK - SIGN UP FOR RESTOCK NOTIFICATIONS.",
      price: 79,
      originalPrice: 99,
      inspirationBrand: "SP5DER",
      inStock: false,
      categoryId: sp5derCategory.id,
      details: "The SP5DER t-shirt features the brand's signature spider web design printed on high-quality cotton fabric. The shirt has a modern fit with a crew neckline and short sleeves, making it perfect for everyday wear or as a statement piece in your streetwear collection. NOT IN STOCK - SIGN UP FOR RESTOCK NOTIFICATIONS.",
